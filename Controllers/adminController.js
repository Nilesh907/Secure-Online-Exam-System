...
// ============================================================
// Convert HTML datetime-local value (IST) → JavaScript Date
// ============================================================
function parseISTDateTime(value) {
    ...
    // 2026-08-23T19:00
    //
    // Treat it explicitly as India Standard Time (+05:30)
...
exports.scheduleExam = async (req, res) => {
    try {
        ...
        // Paper must be approved before scheduling
        if (paper.status !== "APPROVED") {
            return res.status(400).send(
                "Paper must be approved first"
            );
        }

        // Convert IST → UTC correctly
